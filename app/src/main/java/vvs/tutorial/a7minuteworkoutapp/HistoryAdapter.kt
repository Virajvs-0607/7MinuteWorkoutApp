...
import vvs.tutorial.a7minuteworkoutapp.databinding.ItemHistoryRowsBinding
...
class HistoryAdapter(private val items: ArrayList<String>) :
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolder {
        return ViewHolder(ItemHistoryRowsBinding.inflate(
     ...
     */
    class ViewHolder(binding: ItemHistoryRowsBinding) : RecyclerView.ViewHolder(binding.root) {
